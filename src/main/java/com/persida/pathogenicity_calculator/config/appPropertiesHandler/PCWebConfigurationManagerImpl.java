...
@Component
public class PCWebConfigurationManagerImpl implements PCWebConfigurationManager {

    private static Logger logger = Logger.getLogger(PCWebConfigurationManagerImpl.class);
